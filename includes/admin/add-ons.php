...
add_action('admin_head', 'adsensei_admin_inline_css');

/**
 * Create admin inline css to bypass adblock plugin which is blocking wp adsensei css ressources
 */
function adsensei_admin_inline_css() {
    if (!adsensei_is_addon_page()){
        return false;
    }
    echo '<style>
.adsensei-button.green {
...
#adsensei-add-ons .adsensei-footer {
    clear: both;
    margin-top: 20px;
    font-style: italic;
}
...
.adsensei-btn{border:none;color:white;padding:9px 18px;text-align:center;text-decoration:none;display:inline-block;font-size:16px;margin:4px 2px;cursor:pointer;}
.adsensei-btn:hover{color:#fff;}
.adsensei-btn-primary{background-color:#005aef;font-size:16px;border-radius:4px;padding:10px 20px;}
a.adsensei-nav-link-active{border-bottom:3px solid #005af0!important;position:relative;padding:19px 20px;color:#005af0!important;}
.adsensei-logo{height:42px;}
.adsensei-ad-header{display:flex;padding:17px 0% 17px 2%;align-items:center;height:35px;background:#fff;align-items:center;justify-content:space-between;border-bottom:1px solid #D8D8D8;box-shadow:rgba(0, 0, 0, 0.04) 0px 3px 6px 0px;}
.adsensei-ad-menu{display:flex;}
.adsensei-ad-tab ul li{font-size:22px;font-weight:400;}
.adsensei-ad-tab ul{margin:0;}
.adsensei-ad-tab ul li a{color:#111111;text-decoration:none;padding:20px 30px;}
.adsensei-ad-tab ul li a:focus{box-shadow:none;}
.adsensei-ad-tab ul li{display:inline-block;margin-bottom:0;}
.adsensei-ad-tab ul li a.adsensei-btn{border:1px solid #1A73E8;background:none;padding:11px 16px 11px 43px;border-radius:50px;font-size:18px;position:relative;margin:0px 30px 0px 15px;position:relative;top:0px;}
.adsensei-ad-tab ul li a.adsensei-btn span{font-size:32px;color:#1A73E8;position:absolute;top:4px;left:5px;}
.adsensei-ad-tab ul li a.adsensei-btn:hover{background:#1873e8;color:#fff;}
.adsensei-ad-tab ul li a.adsensei-btn:hover span{color:#fff;}
...
.adsensei-ad-tab .adsensei-nav-link{color:#1A73E8;border-bottom:3px solid transparent;}
a.adsensei-nav-link-active{border-bottom:3px solid #005af0!important;position:relative;padding:19px 20px;color:#005af0!important;}
a.adsensei-nav-link:focus{box-shadow:none;}
.adsensei-nav-link{display:block;font-size:12px;top:10px;position:relative;}
.adsensei-ad-tab-wrapper .adsensei-nav-link{top:0;}
.adsensei-ad-tab-wrapper .adsensei-nav-link{font-size:22px;}
.adsensei-ad-header{height:27px;}
}
 ...
 * @return void
 */
function adsensei_add_ons_page() {
    ob_start();

    $freepro_listing = '
	<div class="adsensei-ad-header">
		<div class="adsensei-logo"><img height="42" width="175" src="'.ADSENSEI_PLUGIN_URL.'admin/assets/js/src/images/adsensei-v2-logo.png"></div>
		<a class="adsensei-got_pro premium_features_btn" href="'.admin_url('admin.php?page=adsensei-addons#upgrade_to_premium').'">Upgrade to Premium</a>
		<div class="adsensei-ad-menu">
				<div class="adsensei-ad-tab-wrapper">
					<div class="adsensei-ad-tab">
						<ul>
							<li><a class="adsensei-nav-link" href="'.admin_url('admin.php?page=adsensei-settings').'">Ads</a></li>
							<li><a class="adsensei-nav-link" href="'.admin_url('admin.php?page=adsensei-settings&amp;path=settings').'">Settings</a></li>
							<li class="current"><a class="adsensei-nav-link" href="'.admin_url('admin.php?page=adsensei-settings&amp;path=reports').'">Reports</a></li>
						</ul>
					</div>
				</div>
		</div>
	</div>
<div id="adsensei_freevspro">
    <div class="fp-wr">
        <div class="fp-cnt">
            <h1>Upgrade to Pro</h1>
            <p>Take your Adsensei to the next level Save time & earn more with next level AdSense integration!</p>
            <a class="buy" href="#upgrade">BUY NOW</a>
        </div>
        <div class="pvf">
            <div class="ext">
                <div class="ex-1 e-1">
                    <img src="'.ADSENSEI_PLUGIN_URL . 'assets/images/ex-1.png" />
                    <h4>Features</h4>
                    <p>Includes a suite of advanced features like Ad Rotator, Group Insertion, GEO Location 10+ premium features.</p>
                </div>
                <div class="ex-1 e-2">
                    <img src="'.ADSENSEI_PLUGIN_URL . 'assets/images/ex-2.png" />
                    <h4>Simple Setup</h4>
                    <p>We focus on important stuff and keep it clean and simple. WP ADSENSEI Pro makes it extremely easy to deliver well converting ads to your audience.</p>
                </div>
                <div class="ex-1 e-3">
                    <img src="'.ADSENSEI_PLUGIN_URL . 'assets/images/ex-3.png" />
            ...
            <div class="pvf-cnt">
                <div class="pvf-tlt">
                    ...
                    <span>See what you\'ll get with the WPAdsensei Premium Version</span>
                </div>
                <div class="pvf-cmp">
                    <div class="fr">
                        <h1>FREE</h1>
                        <div class="fr-fe">
                            ...
                            <div class="fe-1">
                                ...
                                <p>We have a full time team which helps you with each and every issue regarding Adsensei.</p>
                            </div>
                        </div><!-- /. fr-fe -->
                    </div><!-- /. fr -->
                    <div class="pr">
                        ...
                        <div class="pr-fe">
                            ...
                            <div class="fet">
                                <div class="fe-2">
                                    <div class="fe-t">
                                        <img src="'.ADSENSEI_PLUGIN_URL . 'assets/images/tick.png" />
                                        <h4>GEO Location</h4>
                                    </div>
                                ...
                                <div class="fe-2">
                                    <div class="fe-t">
                                        <img src="'.ADSENSEI_PLUGIN_URL . 'assets/images/tick.png" />
                                        <h4>Hide Adsensei Markup</h4>
                                    </div>
                                    <p>Hide Adsensei Markup from sourcecode.</p>
                                </div>
                                <div class="fe-2">
                                    <div class="fe-t">
                                        <img src="'.ADSENSEI_PLUGIN_URL . 'assets/images/tick.png" />
            ...
            <div id="upgrade" class="amp-upg">
                ...
                <div class="pri-lst">
                    <div class="pri-tb">
                        <a target="_blank" href="https://adsplugin.net/checkout?edd_action=add_to_cart&amp;download_id=11&amp;edd_options[price_id]=1">
                            <h5>PERSONAL</h5>
                    ...
                    <div class="pri-tb rec">
                        <a target="_blank" href="https://adsplugin.net/checkout?edd_action=add_to_cart&amp;download_id=11&amp;edd_options[price_id]=2">
                            <h5>MULTIPLE</h5>
                    ...
                    <div class="pri-tb ">
                        <a target="_blank" href="https://adsplugin.net/checkout?edd_action=add_to_cart&amp;download_id=11&amp;edd_options[price_id]=3">
                            <h5>WEBMASTER</h5>
                    ...
                    <div class="pri-tb">
                        <a target="_blank" href="https://adsplugin.net/checkout?edd_action=add_to_cart&amp;download_id=11&amp;edd_options[price_id]=4">
                            <h5>FREELANCER</h5>
                ...
                <div class="tru-us">
                    <img src="'.ADSENSEI_PLUGIN_URL . 'assets/images/rating.png" />
                    <h2>Trusted by more that 60,000+ Users!</h2>
                    <p>More than 60k Websites, Blogs & E-Commerce website are powered by our Adsensei making it the #1 Rated Adsensei plugin in WordPress Community.</p>
                    <a href="https://wordpress.org/support/plugin/adsenseib30/reviews/?filter=5" target="_blank">Read The Reviews</a>
                </div>
            </div><!--/ .amp-upg -->
            <div class="ampfaq">
                ...
                <div class="f-cnt">
                    ...
                    <p>All the plans are year-to-year which are subscribed annually.</p>
                    <a href="https://adsplugin.net/help/">Contact a Human</a>
                </div><!-- /.f-cnt -->
            </div><!-- /.faq -->
        </div><!-- /. pvf -->
    </div><!-- /. fp-wr --></div>';
