...
namespace wpadsensei\conditions;
...
class conditions {
    ...
    protected function isExcluded() {
        ...
        // User logged in
        if (is_user_logged_in() && ( isset($adsensei_options['visibility']['AppLogg'])))
            return true;
    ...
    /**
     * Check if ad is deactivated by wp adsensei meta settings in post editor
     * @return boolean
     */
    private function isExcludedByMetaKey() {
        ...
        $value_arr = get_post_meta($post->ID, '_adsensei_config_visibility', true);
