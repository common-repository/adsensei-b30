...
class render extends conditions\conditions {
    ...
    public function __construct() {
        ...
        add_filter('the_content', array($this, 'prepareOutput'), adsensei_get_load_priority());
    }
...
//            }
    ...
    private function isActive(){
        $isActive = get_option('adsensei_vi_active');
    ...
    public function render() {
        ...
        $output = new \wpadsensei\template('/includes/vendor/vi/templates/ad', $args);
        $html .= $output->render();
