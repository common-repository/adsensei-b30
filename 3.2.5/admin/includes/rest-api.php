...
class ADSENSEI_Ad_Setup_Api {
    ...
    const CS = 'dHjumDqZSshxPitfVJErRTcX';
        ...
        public function registerRoute(){
            ...
            register_rest_route( 'apiAdsensei', 'get-ads-list', array(
                    'methods'    => 'GET',
            ...
            register_rest_route( 'apiAdsensei', 'change-mode', array(
                'methods'    => 'POST',
            ...
            register_rest_route( 'apiAdsensei', 'ad-more-action', array(
                'methods'    => 'POST',
            ...
            register_rest_route( 'apiAdsensei', 'update-ad', array(
                'methods'    => 'POST',
            ...
            register_rest_route( 'apiAdsensei', 'update-settings', array(
                'methods'    => 'POST',
            ...
            register_rest_route( 'apiAdsensei', 'validate-ads-txt', array(
                'methods'    => 'POST',
            ...
            register_rest_route( 'apiAdsensei', 'send-customer-query', array(
                'methods'    => 'POST',
            ...
            register_rest_route( 'apiAdsensei', 'get-ad-by-id', array(
                'methods'    => 'GET',
            ...
            register_rest_route( 'apiAdsensei', 'get-settings', array(
                'methods'    => 'GET',
            ...
            register_rest_route( 'apiAdsensei', 'get-condition-list', array(
                'methods'    => 'GET',
            ...
            register_rest_route( 'apiAdsensei', 'export-settings', array(
                'methods'    => 'POST',
            ...
            register_rest_route( 'apiAdsensei', 'import-settings', array(
                'methods'    => 'POST',
            ...
            register_rest_route( 'apiAdsensei', 'get-adsensei-info', array(
                'methods'    => 'GET',
                'callback'   => array($this, 'getAdsenseiInfo'),
                'permission_callback' => function(){
                    return current_user_can( 'manage_options' );
                }
            ));
            register_rest_route( 'apiAdsensei', 'get-user-role', array(
                'methods'    => 'GET',
            ...
            register_rest_route( 'apiAdsensei', 'get-tags', array(
                'methods'    => 'GET',
            ...
            register_rest_route( 'apiAdsensei', 'get-plugins', array(
                'methods'    => 'GET',
             ...
             register_rest_route( 'apiAdsensei', 'get-add-next-id', array(
                'methods'    => 'POST',
             ...
             register_rest_route( 'apiAdsensei', 'adsensei_subscribe_newsletter', array(
                'methods'    => 'POST',
                'callback'   => array($this, 'adsenseiSubscribeNewsletter'),
                'permission_callback' => function(){
                    return current_user_can( 'manage_options' );
                }
            ));
               register_rest_route( 'apiAdsensei', 'import-ampforwp-ads', array(
                'methods'    => 'POST',
               ...
               register_rest_route( 'apiAdsensei', 'import-advance-ads', array(
                'methods'    => 'POST',
               ...
               register_rest_route( 'apiAdsensei', 'import-adsforwp-ads', array(
                'methods'    => 'POST',
            ...
            register_rest_route( 'apiAdsensei', 'reports-adsense-confcode', array(
                'methods'    => 'POST',
	        ...
	        register_rest_route( 'apiAdsensei', 'adsensei_register_ad', array(
		        'methods'    => 'POST',
		        'callback'   => array($this, 'adsensei_register_ad'),
		        'permission_callback' => function(){
			        return current_user_can( 'manage_options' );
		        }
	        ));
            register_rest_route( 'apiAdsensei', 'check_plugin_exist', array(
                'methods'    => 'GET',
            ...
            register_rest_route( 'apiAdsensei', 'getAdloggingData', array(
                'methods'    => 'POST',
                ...
                foreach($all_ads_post as $ads){
                   ...
                   $banner_size = 'responsive';
                    ...
                    $adforwp_meta_key = array(
                        ...
                        'adsensei_ad_old_id'               => 'ad'.$ad_count,
                    );
                    ...
                    require_once ADSENSEI_PLUGIN_DIR . '/admin/includes/migration-service.php';
                        ...
                        $this->migration_service->adsenseiUpdateOldAd('ad'.$ad_count, $adforwp_meta_key);
                        $ad_count++;
                }
                update_option('adsforwp_to_adsensei', 'imported');
            }
            return  array('status' => 't', 'data' => 'Ads have been successfully imported');
        }

 /** Here we are importing Advance ads to Adsensei**/
        ...
        public function importadvance_ads(){
            ...
            foreach ($placements  as $placement) {
                ...
                if(isset($post_meta['0']['type'])  ||  isset($get_Advanced_Ads_group_ads[0]->taxonomy ) && $get_Advanced_Ads_group_ads[0]->taxonomy == "advanced_ads_groups"   ){
                    ...
                    require_once ADSENSEI_PLUGIN_DIR . '/admin/includes/migration-service.php';
                    $this->migration_service = new ADSENSEI_Ad_Migration();
                    $this->migration_service->adsenseiUpdateOldAd($post_id, $advance_ads_meta_key);
                }
            }
            return  array('status' => 't', 'data' => 'Ads have been successfully imported');
        }

     /** Here we are importing AMP for WP and advance Amp ads to Adsensei**/
        ...
        public function adsenseiSubscribeNewsletter($request){
        ...
        public function changeMode($request){
            ...
            $response = update_option('adsensei-mode', $mode);
        ...
        public function getAdsenseiInfo(){
            require_once ADSENSEI_PLUGIN_DIR . 'includes/admin/tools.php';
            $info = adsensei_tools_sysinfo_get();
        ...
        public function importSettings($request){
            ...
            if ( ! empty( $files ) ) {
                ...
                if ( ! empty( $file_data )) {
                    ...
                    $settings = get_option( 'adsensei_settings' );
                    if(!$settings){
                        update_option('adsensei_settings',$file_data);
                        foreach($file_data['ads'] as $ad){
                            $temp_array = array();
                            $temp_array['adsensei_post_meta'] =$ad;
...
return array('status' => 't');
        ...
        public function sendCustomerQuery($request){
             ...
             $message = '<p>'.$message.'</p><br><br>'
                     . $customer_type
                     . '<br><br>'.'Query from WP Adsensei plugin support tab <br> User Website URL: '.site_url();

             if($email && $message){

                 //php mailer variables
                 $sendto    = 'team@ampforwp.com';
                 $subject   = "WP Adsensei Customer Query";
        ...
        public function getSettings($request){
            ...
            $adsensei_settings = get_option('adsensei_settings');           
            $adsensei_settings['QckTags'] = isset($adsensei_settings['quicktags']['QckTags']) ? $adsensei_settings['quicktags']['QckTags'] : false;
            $adsensei_settings['adsforwp_to_adsensei'] = get_option( 'adsforwp_to_adsensei' );
            $post_types = get_post_types();
            $add = array('none' => 'Exclude nothing');
            $adsensei_settings['auto_ads_get_post_types'] =  $add + $post_types;
            $adsensei_settings['autoads_excl_user_roles'] =  array_merge(array('none' => 'Exclude nothing'), $this->adsensei_get_user_roles_api());
            if(file_exists(ABSPATH . 'ads.txt')){
                $adsensei_settings['adsTxtText'] = trim(file_get_contents(ABSPATH . 'ads.txt'));
            }
    ...
    public function getAddNextId(){
        ...
        if(isset($adsensei_options['ads']) && !empty($adsensei_options['ads'])){
            ...
            $post_args = array ( 'post_type'=>'adsensei-ads' );
        ...
        public function getAdList(){
            ...
            if(isset($adsensei_options['ad_performance_tracking']) && $adsensei_options['ad_performance_tracking'] ){

                $new_result =array();
                foreach ($result['posts_data'] as $key => $value) {
                    if(isset($value['post_meta']['ad_id'])){
                    $analytics = adsensei_get_ad_stats('sumofstats',$value['post_meta']['ad_id']);
        ...
        public function getAdloggingData($request){
            ...
            $result =  adsensei_get_ad_stats('search','','',$search_param);
            return $result;
        ...
        public function updateSettings($request_data){
            ...
            if(isset($file['file'])){
                ...
                if( end($parts) != 'json' ) {
                    $response = array('status' => 'f', 'msg' =>  __( 'Please upload a valid .json file', 'adsenseib30' ));
                }

                $import_file = $file['file']['tmp_name'];
                if( empty( $import_file ) ) {
                    $response = array('status' => 'f', 'msg' =>  __( 'Please upload a file to import', 'adsenseib30' ));
                }

                $settings = json_decode( file_get_contents( $import_file ), true);
                update_option( 'adsensei_settings', $settings );
                $response = array('file_status' => 't','status' => 't', 'msg' =>  __( 'file uploaded successfully', 'adsenseib30' ));
                ...
                if(isset($parameters['settings'])){
                    ...
                    if($result){
                        $response = array('status' => 'tp', 'msg' =>  __( 'Settings has been saved successfullycv', 'adsenseib30' ));
                        if(is_array($result)){
                            if ($result['license'] == "invalid") {
                                $response = array('status' => 'lic_not_valid','license'=>$result['license'], 'msgINV' =>  __( 'Settings has been saved successfullyvf', 'adsenseib30' ));
                            }
                            else
                                {
                                    if ($result['license'] == "valid") {
                                        $response = array('status' => 'license_validated','license'=>$result['license'], 'msgV' =>  __( 'Settings has been saved successfullyvf', 'adsenseib30' ));
                                    }
                                }
                            }
                        }
 ...
 * @return array
 */
public function adsensei_get_user_roles_api() {
   global $wp_roles;
   $roles = array();
 ...
 public function adsensei_clear_all_cache(){
...
if(class_exists('ADSENSEI_Ad_Setup_Api')){
    ADSENSEI_Ad_Setup_Api::getInstance();
}
