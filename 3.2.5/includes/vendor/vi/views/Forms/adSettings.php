...
class adSettings {
    ...
    public function setAdForm() {
        ...
        $settings = json_decode(json_encode(get_option("adsensei_vi_ads", array())));
        ...
        $element = new Select(
                "adsensei_vi_ads[ads][1][type]", $options, array(
            "class" => "medium-text",
            "step" => 1,
            "max" => 999999,
            "min" => 0
        ...
        // Keywords
        $element = new Text('adsensei_vi_ads[ads][1][keywords]', array());
        $this->form->add(
        ...
        $element = new Select(
                "adsensei_vi_ads[ads][1][iab1]", $optionsNew, array(
            "class" => "large-text",
            "step" => 1,
            "max" => 999999,
            "min" => 0
        ...
        $element = new Select(
                "adsensei_vi_ads[ads][1][iab2]", $iab2New, array(
            "class" => "large-text"
                )
        );
        ...
        // language
        $element = new Select('adsensei_vi_ads[ads][1][language]', $options);
        $this->form->add(
...
//        );
        ...
        // Layout
        $element = new Radio('adsensei_vi_ads[ads][1][align]', array('default' => 'default', 'left' => 'left', 'middle' => 'middle', 'right' => 'right'));
        $this->form->add(
                $element->setLabel("align")->setDefault(isset($settings->align) ? $settings->align : '')
        );
      
        // Margin Top
        $element = new Numerical('adsensei_vi_ads[ads][1][marginTop]', array());
        $this->form->add(
                $element->setLabel("Top")->setDefault(isset($settings->marginTop) ? $settings->marginTop : '0')
        );
        // Margin Right
        $element = new Numerical('adsensei_vi_ads[ads][1][marginRight]', array());
        $this->form->add(
                $element->setLabel("Top")->setDefault(isset($settings->marginRight) ? $settings->marginRight : '0')
        );
        // Margin Bottom
        $element = new Numerical('adsensei_vi_ads[ads][1][marginBottom]', array());
        $this->form->add(
                $element->setLabel("Top")->setDefault(isset($settings->marginBottom) ? $settings->marginBottom : '0')
        );
        // Margin Left
        $element = new Numerical('adsensei_vi_ads[ads][1][marginLeft]', array());
        $this->form->add(
        ...
        $element = new Select('adsensei_vi_ads[ads][1][position]', $options);
        $this->form->add(
        ...
        $element = new SelectMultiple('adsensei_vi_ads[ads][1][excludedPostTypes]', $options);
        $this->form->add(
        ...
        $element = new SelectMultiple('adsensei_vi_ads[ads][1][excludedExtraPages]', $options);
        $this->form->add(
        ...
        // Hide Ads On Posts
        $element = new Text('adsensei_vi_ads[ads][1][excludedPostIds]', array());
        $this->form->add(
        ...
        $options = array_merge (array('noUserRoles' => 'Exclude nothing'), $this->adsensei_get_user_roles());                  
        $element = new SelectMultiple('adsensei_vi_ads[ads][1][excludedUserRoles]', $options);
        $this->form->add(
     ...
     * @return array
     */
    private function adsensei_get_user_roles() {
        global $wp_roles;
        $roles = array();
