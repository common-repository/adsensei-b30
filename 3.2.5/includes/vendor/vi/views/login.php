...
?>
    ...
    <div id="adsensei-vi-welcome">
        ...
        <p>
            By clicking sign up you agree to send your current domain, email and affiliate ID to video intelligence & WP ADSENSEI. Your data is used only for the purpose of delivering video content and video ads to your site.
        ...
        <div class="adsensei-widget-buttons">
            ...
            <a href="<?php echo $signupURL; ?>?email=<?php echo bloginfo('admin_email'); ?>&domain=<?php echo get_site_url(); ?>" class="button button-primary" id="adsensei-vi-signup"> Signup </a> 
        </div>
    </div>
